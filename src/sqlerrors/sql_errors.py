...
class SqlErrors(IntEnum):
    ...
    TOO_MANY_COLUMNS_IN_SUBQUERY = 26
    MISSING_QUANTIFIER = 106
    ...
    OMITTED_COMMAS = 33
    UNMATCHED_BRACKETS = 107
    CURLY_OR_SQUARE_BRACKETS = 108
    NONSTANDARD_KEYWORDS_OR_STANDARD_KEYWORDS_IN_WRONG_CONTEXT = 36
    NONSTANDARD_OPERATORS = 37
    DIFFERENT_TUPLES_IN_SET_OPERATION = 109
    ...
    MISSING_WHERE_CLAUSE = 112
    MISSING_GROUP_BY_CLAUSE = 113
    MISSING_HAVING_CLAUSE = 114
    MISSING_ORDER_BY_CLAUSE = 115
    MISSING_LIMIT_CLAUSE = 116
    MISSING_OFFSET_CLAUSE = 117
    EXTRANEOUS_WHERE_CLAUSE = 118
    EXTRANEOUS_GROUP_BY_CLAUSE = 119
    EXTRANEOUS_HAVING_CLAUSE = 120
    EXTRANEOUS_ORDER_BY_CLAUSE = 76
    EXTRANEOUS_LIMIT_CLAUSE = 121
    EXTRANEOUS_OFFSET_CLAUSE = 122
    INCORRECT_LIMIT = 123
    INCORRECT_OFFSET = 124
    ...
    CORRELATION_NAME_IDENTICAL_TO_TABLE_NAME = 125
