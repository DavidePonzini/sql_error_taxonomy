...
| ID  | Name
| :-- | :---
| SEM_IMPLIED_OR_CONSTANT_LOGIC | [Implied, tautological or inconsistent expression](definitions/2_sem/implied_tautological_or_inconsistent_expression.md)
...
| SEM_GT0_IS_NOT_NULL_OR_EMPTY_STRING_NULL | [Mixing a >0 with IS NOT NULL or empty string with NULL](definitions/2_sem/mixing_a_0_with_is_not_null_or_empty_string_with_null.md)
### Inconsistent join
| ID  | Name
| :-- | :---
...
| ID  | Name
| :-- | :---
| LOG_NESTING_EXPRESSIONS | [Improper nesting of expressions](definitions/3_log/improper_nesting_of_expressions.md)
| LOG_NESTING_SUBQUERIES | [Improper nesting of subqueries](definitions/3_log/improper_nesting_of_subqueries.md)
### Expression error
| ID  | Name
| :-- | :---
...
| LOG_EXPRESSION_INCORRECT_COLUMN | [Expression on incorrect column](definitions/3_log/expression_on_incorrect_column.md)
| LOG_EXPRESSION_INCORRECT_CLAUSE | [Expression in incorrect clause](definitions/3_log/expression_in_incorrect_clause.md)
| LOG_WILDCARD_EQ | [Wildcards without LIKE](definitions/3_log/wildcards_without_like.md)
| LOG_WILDCARD_WRONG | [Wrong wildcard](definitions/3_log/wrong_wildcard.md)
| LOG_WILDCARD_INVALID | [Invalid wildcard](definitions/3_log/invalid_wildcard.md)
### Projection error
| ID  | Name
| :-- | :---
